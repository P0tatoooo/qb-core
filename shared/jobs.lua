...
QBShared.Jobs = {
	...
	police = {
		...
		grades = {
            ...
            ['4'] = { name = 'Lieutenant', payment = 125 },
            ['5'] = { name = 'Lieutenant', payment = 125 },
            ['6'] = { name = 'Lieutenant', payment = 125 },
            ['7'] = { name = 'Lieutenant', payment = 125 },
            ['8'] = { name = 'Lieutenant', payment = 125 },
            ['9'] = { name = 'Lieutenant', payment = 125 },
            ['10'] = { name = 'Lieutenant', payment = 125 },
            ['11'] = { name = 'Lieutenant', payment = 125 },
			['12'] = { name = 'Chief', isboss = true, payment = 150 },
		},
	},
	ambulance = {
		label = 'EMS',
